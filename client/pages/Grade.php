                ...
                <form method="POST class="h-full flex flex-col justify-between">
                            ...
                            <div class="h-full w-full">
                                <div class="py-2 flex items-center gap-2 justify-between relative">
                                    ...
                                    <div id="searchBar" class="hidden bg-white absolute max-h-44 top-20 w-full rounded-lg shadow overflow-hidden overflow-y-auto">
                                        <div class="p-5 border-b borde-b-slate-200">
                                            <h3>Borcelo, Angeline B.</h3>
                                            <small>LRN: 2831027491203</small>
                                        </div>
                                        <div class="p-5 border-b borde-b-slate-200">
                                            <h3>Borcelo, Angeline B.</h3>
                                            <small>LRN: 2831027491203</small>
                                ...
                                <div class="py-2 flex items-end gap-2 justify-between">
                                    ...
                                    <div class="flex items-center w-auto">
                                        <button class="py-2 px-5 bg-blue-600 text-white font-normal rounded-md hover:bg-blue-500">Add</button>
                                    </div>
                                </div>
                            </div>
